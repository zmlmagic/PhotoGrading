...
@interface LGZmlNavigationController ()
{
    CGPoint startTouch;
...
@implementation LGZmlNavigationController
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self)
    {
        ...
        //[[UINavigationBar appearance] setBackgroundColor:RGB(216, 56, 49)];
        //[[UINavigationBar appearance] setBarTintColor:RGB(216, 56, 49)];
